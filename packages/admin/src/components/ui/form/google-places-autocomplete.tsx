  ...
  return isLoaded ? (
    ...
    >
      <input
        ...
        className="px-4 h-12 flex items-center w-full rounded appearance-none transition duration-300 ease-in-out text-gray-600 text-sm focus:outline-none focus:ring-0 border border-border-base focus:border-accent"
      />
    </Autocomplete>
  ) : (
