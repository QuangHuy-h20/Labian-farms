...
const classes = {
  root: "py-3 px-4 w-full rounded appearance-none transition duration-300 ease-in-out text-gray-600 text-sm focus:outline-none focus:ring-0",
  normal:
...
const TextArea = React.forwardRef<HTMLTextAreaElement, Props>((props, ref) => {
  ...
  return (
    <div className={className}>
      {label && (
        <label className="block text-gray-500 font-semibold text-sm leading-none mb-3">
          {label}
        </label>
      )}
      <textarea
