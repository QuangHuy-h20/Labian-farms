  ...
  return (
    <div className={className}>
      ...
      <div className="space-y-2 mt-4">
        ...
        {discount && coupon ? (
          <div className="flex justify-between">
            <p className="text-sm text-gray-400 me-4">{t("text-discount")}</p>
            ...
            <span className="text-sm text-gray-400">{discountPrice}</span>
          </div>
        ) : (
      ...
      {use_wallet && !Boolean(payableAmount) ? null : (
        <PaymentGrid className="bg-white p-5 border border-gray-200 mt-10" />
      )}
