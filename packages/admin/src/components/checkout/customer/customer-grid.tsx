    ...
    <div className={className}>
      <div className="flex items-center justify-between mb-5 md:mb-8">
        <div className="flex items-center space-s-3 md:space-s-4">
          ...
          <p className="text-lg lg:text-xl text-gray-600 capitalize">{label}</p>
        </div>
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3">
        ...
        {customer?.value ? (
          <div className="relative p-4 h-full rounded border cursor-pointer group hover:border-accent border-accent shadow-sm bg-white">
