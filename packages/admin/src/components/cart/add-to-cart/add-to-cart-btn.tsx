    ...
    case "argon":
      return (
        <button
          onClick={onClick}
          disabled={disabled}
          className="w-7 h-7 md:w-9 md:h-9 flex items-center justify-center text-sm text-gray-600 bg-white rounded border border-border-200 transition-colors hover:bg-accent hover:border-accent hover:text-light focus:outline-none focus:bg-accent focus:border-accent focus:text-light"
        >
      ...
      return (
        <button
          ...
          className={cn(
            ...
            {
              "border !bg-gray-300 hover:!bg-gray-300 border-border-400 !text-gray-400 cursor-not-allowed":
                disabled,
            }
          )}
        >
    ...
    default:
      return (
        <button
          ...
          className="w-7 h-7 md:w-9 md:h-9 flex items-center justify-center text-sm text-accent bg-white rounded border border-border-200 transition-colors hover:bg-accent hover:border-accent hover:text-light focus:outline-none focus:bg-accent focus:border-accent focus:text-light"
        >
          <span className="sr-only">{t("text-plus")}</span>
          <PlusIcon className="w-5 h-5 stroke-2" />
        </button>
