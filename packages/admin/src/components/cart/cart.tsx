...
const Cart = () => {
  ...
  return (
    <section className="flex flex-col h-full relative bg-white">
      <header className="fixed max-w-md w-full h-16 top-0 z-10 bg-white px-6 flex items-center justify-between border-b border-border-200 border-opacity-75">
      ...
      <footer className="fixed bottom-0 w-full max-w-md py-5 px-6 z-10 bg-white">
        ...
        >
          ...
          <span className="flex items-center flex-shrink-0 h-full bg-white text-accent rounded-full px-5">
            {totalPrice}
          </span>
        </button>
      </footer>
