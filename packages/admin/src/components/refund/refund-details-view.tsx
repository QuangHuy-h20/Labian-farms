  ...
  return (
    <Card>
      <div className="flex flex-col lg:flex-row items-center">
        <h3 className="text-2xl font-semibold text-gray-600 text-center lg:text-start w-full lg:w-1/3 mb-8 lg:mb-0 whitespace-nowrap">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between">
        <div className="w-full sm:w-1/2 sm:pe-8 mb-10 sm:mb-0">
          <h3 className="text-gray-600 font-semibold mb-3 pb-2 border-b border-border-200">
            {t("common:billing-address")}
          </h3>

          <div className="text-sm text-gray-400 flex flex-col items-start space-y-1">
        ...
        <div className="w-full sm:w-1/2 sm:ps-8">
          <h3 className="text-gray-600 text-start font-semibold sm:text-end mb-3 pb-2 border-b border-border-200">
            {t("common:shipping-address")}
          </h3>

          <div className="text-sm text-gray-400 text-start sm:text-end flex flex-col items-start sm:items-end space-y-1">
            <span>{refund?.order?.customer?.name}</span>
