...
const NotificationMenu: React.FC<MenuType> = ({ data }) => {
  ...
  return (
    <>
      <button
        className="relative flex items-center justify-center rounded outline-none transition duration-300 ease-in-out text-gray-600 focus:ring-1 focus:outline-none"
          ...
          {isOpen && (
            ...
            >
              ...
              {!!data.length ? (
                ...
                <div className="bg-white flex items-center justify-center border-b border-border-200">
