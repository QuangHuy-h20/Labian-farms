...
const ProductCard = ({ item }: Props) => {
  ...
  return (
    <div className="cart-type-neon border border-border-200 rounded h-full bg-white overflow-hidden shadow-sm transition-all duration-200 hover:shadow-md">
      {/* <h3>{name}</h3> */}
      ...
      <header className="p-3 md:p-6">
        {product_type === ProductType.Variable ? (
          ...
          //     </span>
          //     {discount && (
          //       <del className="text-xs md:text-sm text-gray-400 ms-2">
          //         {basePrice}
          //       </del>
          //     )}
          //   </div>
        ...
        <h3 className="text-xs md:text-sm text-gray-400 truncate mb-4">{name}</h3>
