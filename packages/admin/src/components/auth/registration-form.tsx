...
const RegistrationForm = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center relative text-sm text-gray-600 mt-8 sm:mt-11 mb-6 sm:mb-8">
        <hr className="w-full" />
        <span className="absolute start-2/4 -top-2.5 px-2 -ms-4 bg-white">
          {t("common:text-or")}
        </span>
      </div>
